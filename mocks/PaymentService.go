...
func (_m *PaymentService) FindOrCreatePayment(orderID uint, _a1 payment.Payment) (payment.Payment, error) {
...
func (_m *PaymentService) GetOrderByID(id uint) (*order.Order, error) {
	ret := _m.Called(id)
...
func (_m *PaymentService) Update(orderID uint, _a1 payment.Payment) (payment.Payment, error) {
	ret := _m.Called(orderID, _a1)
